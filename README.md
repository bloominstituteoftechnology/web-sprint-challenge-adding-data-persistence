...
1. Explain the difference between `Relational Databases` and `SQL`.
  ...
  Relational databases store data in tables. SQL is how you communicate with the table

2. Why do tables need a `primary key`?

  So the items in the table can be identified and connected to other tables using a foreign key.
