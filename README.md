...
- SQL is a database management langauge, relational databases are one way to store that data

2. Why do tables need a `primary key`?

- primary keys are used to identify each item in a table
...
- one table has multiple foreign keys
