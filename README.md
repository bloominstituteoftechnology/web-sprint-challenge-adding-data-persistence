...
1. Explain the difference between Relational Databases and SQL.
   RDBMS is a database management system. And SQL is the language used for communicating with data in an RDBMS.

2. Why do tables need a Primary Key?
   The primary key ensure uniqueness in the table

3. What is the name given to a table column that references the Primary Key on another table?
   A foreign key

4. What do we need in order to have a _many to many_ relationship between two tables?
   A Junction Table. A Junction table in a database, also referred to as a Bridge table or Associative Table, bridges the tables together by referencing the primary keys of each data table.
