...
1. Explain the difference between `Relational Databases` and `SQL`.
  ...
  a relational database is where the data is organized and stored
  sql is the language that is used

2. Why do tables need a `primary key`?

  to make it easier to find a record among the many records that could have similar date
...
4. What do we need in order to have a _many to many_ relationship between two tables.
  ...
  the data needs to be able to be used in multiple places
